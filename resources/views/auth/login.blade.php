...
@section('content')
    ...
    <form class="form-horizontal form-material" id="loginform" action="{{ route('login') }}" method="POST">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td>Admin</td>
                <td>admin@wilcode.com</td>
                <td>123456</td>
                <td><a href="javascript:;" data-email="admin@wilcode.com" data-password="123456" class="text-muted copy-login"><i class="fa fa-clipboard"></i></a></td>
            </tr>
            <tr>
                <td>Employee</td>
                <td>employee@example.com</td>
                <td>123456</td>
                <td><a href="javascript:;" data-email="employee@example.com" data-password="123456" class="text-muted copy-login"><i class="fa fa-clipboard"></i></a></td>
            </tr>
            <tr>
                <td>Client</td>
                <td>client@example.com</td>
                <td>123456</td>
                <td><a href="javascript:;" data-email="client@example.com" data-password="123456" class="text-muted copy-login"><i class="fa fa-clipboard"></i></a></td>
            </tr>
            </tbody>
        </table>
    </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 m-t-10 text-center">
                ...
                <pre class="prettyprint lang-html linenums"><strong>Admin</strong>
...
Password:123456
                ...
                <pre class="prettyprint lang-html linenums"><strong>Employee</strong>
Email: employee@example.com
Password:123456
</pre>
</td><td>

                <pre class="prettyprint lang-html linenums"><strong>Client</strong>
